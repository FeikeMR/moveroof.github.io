...
<section id="home-packages-desktop" class="only-desktop">
    ...
    <div class="home-packages-container">
      ...
      <div class="home-package">
        <img class="home-package-image" src="/public/assets/visuals/general/packagevis-starter.svg" alt="Starter">
        ...
        <div class="home-package-content">
          <div class="home-package-service-row">
            <img src="public/assets/visuals/icons/check-icon.svg" alt="check">
          ...
          <div class="plus-row">
            <img src="public/assets/visuals/icons/plus-icon.svg" alt="Plus">
      ...
      <div class="home-package premium">
        ...
        <img class="home-package-image premium-img" src="/public/assets/visuals/general/packagevis-premium.svg" alt="Premium">
      ...
      <!-- All-In -->
      <div class="home-package">
        <img class="home-package-image" src="/public/assets/visuals/general/packagevis-allin.svg" alt="All-In">
  ...
  <section id="home-packages-mobile" class="only-mobile">
    ...
    >
      ...
      <div class="home-package-mobile" data-package-index="0">
        ...
        <div class="home-package-content">
          <div class="home-package-service-row"><img src="public/assets/visuals/icons/check-icon.svg" alt="check"><p>Funda advertentie</p></div>
          <div class="home-package-service-row"><img src="public/assets/visuals/icons/check-icon.svg" alt="check"><p>Template officiële docs</p></div>
          <div class="home-package-service-row"><img src="public/assets/visuals/icons/check-icon.svg" alt="check"><p>Onderhandel begeleiding</p></div>
          <div class="plus-row">
            <img src="public/assets/visuals/icons/plus-icon.svg" alt="Plus">
            <p>Plus nog veel meer!</p>
          </div>
      ...
      <div class="home-package-mobile premium" data-package-index="1">
        <div class="home-most-chosen-tag">Meest gekozen</div>
        <img class="home-package-image" src="/public/assets/visuals/general/packagevis-premium.svg" alt="Premium">
        <h3>Premium</h3>
        <p class="home-package-description">Bespaar duizenden euro's & behoudt de zelfstandigheid.</p>
        <div class="home-package-price">
          <h4>€850,-</h4>
        ...
        <div class="home-package-content">
          <div class="home-package-service-row"><img src="public/assets/visuals/icons/check-icon.svg" alt="check"><p>Advies verkoopprijs</p></div>
          <div class="home-package-service-row"><img src="public/assets/visuals/icons/check-icon.svg" alt="check"><p>NEN2580 meetrapport</p></div>
          <div class="plus-row">
            <img src="public/assets/visuals/icons/plus-icon.svg" alt="Plus">
            <p>Plus nog veel meer!</p>
          </div>
      ...
      <div class="home-package-mobile" data-package-index="2">
        ...
        <div class="home-package-content">
          <div class="home-package-service-row"><img src="public/assets/visuals/icons/check-icon.svg" alt="check"><p>Video plaatsing Funda</p></div>
          <div class="home-package-service-row"><img src="public/assets/visuals/icons/check-icon.svg" alt="check"><p>Jouw overeenkomst opstellen</p></div>
        </div>
        <button
          class="home-mobile-cta"
          on:click={() => choosePackage('All-In')}
