  ...
  <div id="footer-row-top">
    <div id="footer-brand-group">
      <img
        ...
        src="/svelte/assets/visuals/logos/full-logo/full-logo-yellow-orange-light.svg"
        alt="Full MoveRoof Logo"
      />
      <img
        id="footer-logo-icon"
        class="footer-logo-icon"
        src="/svelte/assets/visuals/logos/icon-logo/logo-icon-yellow-orange-light.svg"
    ...
    <div id="footer-icon-row">
      ...
      <img
        ...
        src="/svelte/assets/visuals/icons/funda-icon.png"
        alt="Funda logo icon"
      />
    </div>
  </div>
