...
class RealtimeClient {
    ...
    connect() {
        ...
        import('./wrapper-9Dom41dB.js').then(({ default: WS }) => {
...
class GoTrueClient {
    ...
    _debug(...args) {
        if (this.logDebugMessages) {
            this.logger(`GoTrueClient@${this.instanceID} (${version$1}) ${new Date().toISOString()}`, ...args);
        }
        return this;
    }
    /**
...
export { createClient as c, getDefaultExportFromCjs as g };
//# sourceMappingURL=index3-QiWydKBQ.js.map
