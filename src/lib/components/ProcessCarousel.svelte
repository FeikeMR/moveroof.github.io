    ...
    >
      ...
      >
        <button class="arrow left-arrow" on:click={prevSlide}>
          <img src="assets/visuals/icons/left-arrow-icon.svg" alt="prev" />
        </button>
        <div class="carousel-content">
          <div class="carousel-image">
            <img
              src="assets/visuals/general/process-step1-signup.png"
              alt="Slide 1"
            />
          </div>
        ...
        <button class="arrow right-arrow" on:click={nextSlide}>
          <img src="assets/visuals/icons/right-arrow-icon.svg" alt="next" />
        </button>
      </div>
      ...
      >
        ...
        <div class="carousel-content">
          <div class="carousel-image">
            <img
              src="assets/visuals/general/process-step2-online.png"
              alt="Slide 2"
            />
          </div>
          <div class="carousel-text">
      ...
      >
        ...
        <div class="carousel-content">
          <div class="carousel-image">
            <img
              src="assets/visuals/general/process-step3-tours.png"
              alt="Slide 3"
            />
          </div>
          <div class="carousel-text">
      ...
      >
        ...
        <div class="carousel-content">
          <div class="carousel-image">
            <img
              src="assets/visuals/general/process-step4-negotiate.png"
              alt="Slide 4"
            />
          </div>
          <div class="carousel-text">
      ...
      >
        ...
        <div class="carousel-content">
          <div class="carousel-image">
            <img
              src="assets/visuals/general/process-step5-celebrate.png"
              alt="Slide 5"
            />
          </div>
          <div class="carousel-text">
