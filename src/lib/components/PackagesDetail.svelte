  ...
  <section id="combined-packages-services" class="only-desktop">
    ...
    <div class="packages-container">
      ...
      <div class="package" id="Starter">
        ...
        <div class="package-price-detail">
          <p class="price">€395,-</p>
          <img class="package-image" src="/assets/visuals/general/packagevis-starter.svg" />
        </div>
        <button
      ...
      <div class="package" id="Premium">
        ...
        <div class="package-price-detail">
          <p class="price">€850,-</p>
          <img class="package-image" src="/assets/visuals/general/packagevis-premium.svg" />
        </div>
        <button
          class="desktop-cta-button"
      ...
      <div class="package" id="All-In">
        ...
        <div class="package-price-detail">
          ...
          <img class="package-image" src="/assets/visuals/general/packagevis-allin.svg" />
        </div>
        <button
          class="desktop-cta-button"
    ...
    <div class="services-container">
      ...
      <div class="service-row">
        ...
        <div class="service-icon"><img src="assets/visuals/icons/check-icon.svg" alt="check"></div>
        <div class="service-icon"><img src="assets/visuals/icons/check-icon.svg" alt="check"></div>
        <div class="service-icon"><img src="assets/visuals/icons/check-icon.svg" alt="check"></div>
      </div>
      <div class="service-row">
        <div class="service-name">Templates officiële documenten</div>
        <div class="service-icon"><img src="assets/visuals/icons/check-icon.svg" alt="non-check"></div>
        <div class="service-icon"><img src="assets/visuals/icons/check-icon.svg" alt="check"></div>
        <div class="service-icon"><img src="assets/visuals/icons/check-icon.svg" alt="check"></div>
      </div>
      <div class="service-row">
      ...
      <div class="service-row">
        ...
        <div class="service-icon"><img src="assets/visuals/icons/non-check-icon.svg" alt="non-check"></div>
        <div class="service-icon"><img src="assets/visuals/icons/check-icon.svg" alt="check"></div>
        <div class="service-icon"><img src="assets/visuals/icons/check-icon.svg" alt="check"></div>
      </div>
      <div class="service-row">
      ...
      <div class="service-row">
        ...
        <div class="service-icon"><img src="assets/visuals/icons/non-check-icon.svg" alt="check"></div>
        <div class="service-icon"><img src="assets/visuals/icons/check-icon.svg" alt="check"></div>
        <div class="service-icon"><img src="assets/visuals/icons/check-icon.svg" alt="check"></div>
      </div>
      <div class="service-row">
  ...
  <section id="combined-packages-services-mobile" class="only-mobile">
    ...
    <div class="mobile-services-container">
      ...
      <div class="services-for-package" data-package-services="0" style="display: block;">
        <ul>
          <li><img src="assets/visuals/icons/check-icon.svg" alt="check"> Verkooptips &amp; -informatie</li>
          <li><img src="assets/visuals/icons/check-icon.svg" alt="check"> Templates officiële documenten</li>
          <li><img src="assets/visuals/icons/check-icon.svg" alt="check"> Funda advertentie met foto's</li>
          <li><img src="assets/visuals/icons/check-icon.svg" alt="check"> Advertentietekst kosteloos aanpassen</li>
          <li><img src="assets/visuals/icons/check-icon.svg" alt="check"> Open huis vermelding op Funda</li>
          <li><img src="assets/visuals/icons/check-icon.svg" alt="check"> Funda statistieken</li>
          <li><img src="assets/visuals/icons/check-icon.svg" alt="check"> Onderhandel begeleiding</li>
          <li><img src="assets/visuals/icons/check-icon.svg" alt="check"> Verkoopovereenkomst templates &amp; begeleiding</li>
        </ul>
      </div>
      <!-- Premium Services -->
      <div class="services-for-package" data-package-services="1" style="display: none;">
        ...
        <ul>
          <li><img src="assets/visuals/icons/check-icon.svg" alt="check"> Advies verkoopprijs</li>
          <li><img src="assets/visuals/icons/check-icon.svg" alt="check"> Wij schrijven de advertentietekst</li>
          <li><img src="assets/visuals/icons/check-icon.svg" alt="check"> NEN2580 meetrapport</li>
          <li><img src="assets/visuals/icons/check-icon.svg" alt="check"> Professionele plattegrond</li>
        </ul>
      </div>
      <!-- All-In Services -->
      <div class="services-for-package" data-package-services="2" style="display: none;">
        ...
        <ul>
          <li><img src="assets/visuals/icons/check-icon.svg" alt="check"> Video plaatsing op Funda</li>
          <li><img src="assets/visuals/icons/check-icon.svg" alt="check"> Wij stellen de verkoopovereenkomst op</li>
        </ul>
      </div>
      <div class="services-note">
        <h4 class="secondary">Services notitie</h4>
